...
# plot_plantilla(filter_type = 'bandpass', fpass = fpass, ripple = ripple , fstop = fstop, atenuacion = atenuacion)  
plt.legend()  
plt.show()
...
# Filtrado con el filtro definido (suponiendo sos ya definido)
ppg_filtrado = sig.sosfilt(sos2, ppg, axis=0)
