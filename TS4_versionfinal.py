...
def graficar_espectros(fft_data, frecs, bfrec, titulo, label=None, alpha=0.5, linestyle='-', color=None):
    ...
    plt.show()
#%%
def graficar_histogramas_frecuencias(diccionario_frecuencias, bins=30, titulo='Histogramas de Frecuencia FFT', zero_padding=0):
    """
    ...
    Parámetros:
        ...
        zero_padding: si es 1, se añade " (con zero padding)" al título
    """
    plt.figure(figsize=(10, 5))
...
graficar_histogramas_frecuencias(histogramas_dict, zero_padding=0)
# Sesgo y varianza
...
graficar_histogramas_frecuencias(histogramas_dict, zero_padding=1)
